        ...
        <div className="fixed bottom-0 left-0 z-50 w-full h-16 bg-white border-t dark:bg-background md:hidden">
            <div className="grid h-full max-w-lg grid-cols-3 mx-auto">
                <Link href="/" title={siteConfig.name}
                    ...
                    <span
                        className="text-sm text-muted-foreground group-hover:text-foreground">Home</span>
                </Link>
                ...
                <button type="button"
                    ...
                    <span
                        className="text-sm text-muted-foreground group-hover:text-foreground">Settings</span>
                </button>
                ...
                <Link href="/login" title={siteConfig.name}
                    ...
                    <span
                        className="text-sm text-muted-foreground group-hover:text-foreground">User</span>
                </Link>
            </div>
        </div>
    )
